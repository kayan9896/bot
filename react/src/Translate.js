...
export default function Translate() {
    ...
    conat[recording, setRecording] = React.useState(false);
  ...
  async function write() {
    ...
    useEffect(function(){
        ...
        let submit = document.getElementById('record');
  ...
  return (
    <div style={{display:'flex',width:'80%',height:'100%',justifyContent:'space-evenly'}}>
        <div style={{display:'flex', flexDirection:'column',height:'100%',width:'45%',alignItems:'center'}}>
            ...
            <select id='ori' style={{padding:'1px',width:'30%',verticalAlign:'top'}}>
            ...
            <button id='record' style={{padding:'0 2px',margin:'0 20px',verticalAlign:'top',cursor:'pointer'}}>Record</button>
            <button id='upload' style={{padding:'0 2px',margin:'0 20px',verticalAlign:'top',cursor:'pointer'}}>Upload voice</button>
            </div>
